...
<template>
    ...
    >
        ...
        <footer class=" bg-secondary text-primary py-3  md:mb-1"
                :class="$page.props.auth && $page.props.auth.user? 'pb-24 md:pb-2' : ''">
        ...
        <Navigation v-if="$page.props.auth && $page.props.auth.user" />
    </div>

            ...
            <main class="flex-1 md:ml-56 p-1 md:p-6 lg:p-8 pb-16 md:pb-4">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                        <!-- Empty State -->
                        <div v-if="repairs.length === 0" class="flex flex-col items-center justify-center py-16 px-4">
                            ...
                            <table class="w-full">
                                ...
                                >
                                    ...
                                    <td class="px-1 lg:px-4 py-4 text-sm text-gray-800 font-medium">
                                        {{ repair.client_name.length > 10 ? repair.client_name.slice(0, 10) + '...' : repair.client_name }}
                                    </td>
                                    ...
                                    <td class="px-1 flex flex-col justify-between lg:px-4 py-4 text-sm">
                                        <button
                                            ...
                                            class="py-1 hover:bg-gray-200 px-1 text-blue-500 hover:text-blue-600 inline-flex items-center gap-1.5 text-secondary hover:text-secondary-dark font-medium transition-colors duration-150 group-hover:underline"
                                        >
                    ...
                    <!-- Results count -->
                    <div v-if="repairs.length > 0" class="mt-4 text-sm text-gray-600 text-center md:text-left">
                        Showing <span class="font-semibold text-gray-800">{{ repairs.length }}</span> repair{{ repairs.length !== 1 ? 's' : '' }}
                    </div>
                </div>
            </main>
        </div>
